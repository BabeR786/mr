...
\033[1;31m\033[1;31m║\033[0;33m\033[1;33m* FACEBOOK: \033[1;39mhttps://www.facebook.com/AmiRbabeR4   \033[1;31m║
...
jalan("    \033[1;93m▇▇\033[1;92m       LikE My FB PaGe  AmirBabeR4    \033[1;93m▇▇")
jalan("    \033[1;93m ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Serious Please! Contact To Amir BabER"
            os.system('xdg-open https://www.facebook.com/AmirBabeR945')
    else:
        print "Wrong Dear! Contact Admin Through Facebook Page"
        os.system('xdg-open https://fb.me/AmirBabeR4')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/AmiRbabeR4')
